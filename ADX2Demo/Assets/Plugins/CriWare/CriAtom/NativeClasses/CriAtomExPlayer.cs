...
public class CriAtomExPlayer : CriDisposable
{
	...
	public override void Dispose()
	{
		...
		if (this.entryPoolHandle != IntPtr.Zero) {
			...
			CRIWARECFE8568E(this.entryPoolHandle);
		}
	...
	public void PrepareEntryPool(int capacity, bool stopOnEmpty)
	{
		...
		this.entryPoolHandle = CRIWARE54D5CC59(this.handle, capacity, this.max_path, stopOnEmpty);
		if (this.entryPoolHandle != IntPtr.Zero) {
	...
	public int GetNumEntries()
	{
		...
		return CRIWARED1DD9CA2(this.entryPoolHandle);
	}
	...
	public bool EntryFile(CriFsBinder binder, string path, bool repeat)
	{
		...
		return CRIWAREA7A908A8(this.entryPoolHandle, 
	...
	public bool EntryContentId(CriFsBinder binder, int contentId, bool repeat)
	{
		...
		return CRIWARE5DE4AF00(this.entryPoolHandle, 
								(binder != null) ? binder.nativeHandle : IntPtr.Zero,
								contentId,
								repeat);
	}
	...
	public bool EntryData(byte[] buffer, int size, bool repeat)
	{
		...
		return CRIWARED035DE14(this.entryPoolHandle, buffer, size, repeat);
	}
 ...
 */
	public bool EntryCue(CriAtomExAcb acb, string name, bool repeat)
	{
		...
		return CRIWARE3EDE3F99(this.entryPoolHandle,
	...
	public void Stop(bool ignoresReleaseTime)
	{
		...
		if (this.entryPoolHandle != IntPtr.Zero) {
			CRIWARE5CB65675(this.entryPoolHandle);
		}
	}
	...
	[DllImport(CriWare.pluginName, CallingConvention = CriWare.pluginCallingConvention)]
	private static extern IntPtr CRIWARE54D5CC59(IntPtr player, int capacity, int max_path, bool stopOnEmpty);

	[DllImport(CriWare.pluginName, CallingConvention = CriWare.pluginCallingConvention)]
	private static extern void CRIWARECFE8568E(IntPtr pool);

	[DllImport(CriWare.pluginName, CallingConvention = CriWare.pluginCallingConvention)]
	private static extern int CRIWARED1DD9CA2(IntPtr pool);

	[DllImport(CriWare.pluginName, CallingConvention = CriWare.pluginCallingConvention)]
	private static extern bool CRIWAREA7A908A8(IntPtr pool, IntPtr binder, string path, bool repeat, int max_path);

	[DllImport(CriWare.pluginName, CallingConvention = CriWare.pluginCallingConvention)]
	private static extern bool CRIWARE5DE4AF00(IntPtr pool,  IntPtr binder, int id, bool repeat);

	[DllImport(CriWare.pluginName, CallingConvention = CriWare.pluginCallingConvention)]
	private static extern bool CRIWARED035DE14(IntPtr pool, byte[] buffer, int size, bool repeat);

	[DllImport(CriWare.pluginName, CallingConvention = CriWare.pluginCallingConvention)]
	private static extern bool CRIWARED035DE14(IntPtr pool, IntPtr buffer, int size, bool repeat);

	[DllImport(CriWare.pluginName, CallingConvention = CriWare.pluginCallingConvention)]
	private static extern bool CRIWARE3EDE3F99(IntPtr pool, IntPtr acbhn, string name, bool repeat);

	[DllImport(CriWare.pluginName, CallingConvention = CriWare.pluginCallingConvention)]
	private static extern void CRIWARE5CB65675(IntPtr pool);
	...
	[DllImport(CriWare.pluginName, CallingConvention = CriWare.pluginCallingConvention)]
	private static extern void CRIWAREA0EB61FA(IntPtr player, bool sw);
    ...
    public void SetCue(string v1, string v2)
    {
	...
	private static IntPtr CRIWARE54D5CC59(IntPtr player, int capacity, int max_path, bool stopOnEmpty) { return new IntPtr(1); }
	private static void CRIWARECFE8568E(IntPtr pool) { }
	private static int CRIWARED1DD9CA2(IntPtr pool) { return 0; }
	private static bool CRIWAREA7A908A8(IntPtr pool, IntPtr binder, string path, bool repeat, int max_path) { return true; }
	private static bool CRIWARE5DE4AF00(IntPtr pool,  IntPtr binder, int id, bool repeat) { return true; }
	private static bool CRIWARED035DE14(IntPtr pool, byte[] buffer, int size, bool repeat) { return true; }
	private static bool CRIWARED035DE14(IntPtr pool, IntPtr buffer, int size, bool repeat) { return true; }
	private static bool CRIWARE3EDE3F99(IntPtr pool, IntPtr acbhn, string name, bool repeat) { return true; }
	private static void CRIWARE5CB65675(IntPtr pool) { }
	...
	private void CRIWAREA0EB61FA(IntPtr player, bool sw) { _dummyLoop = sw; }
