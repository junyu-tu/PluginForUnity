...
public abstract class CriAtomExVoicePool : CriDisposable
{
	...
	{
		/* 機種共通のボイスプールID */
#if UNITY_EDITOR || UNITY_STANDALONE_WIN || UNITY_STANDALONE_OSX || UNITY_ANDROID || UNITY_IOS || UNITY_TVOS || UNITY_PS3 || UNITY_PS4 || UNITY_WINRT || UNITY_XBOXONE || UNITY_WEBGL || UNITY_SWITCH || UNITY_STADIA || UNITY_STANDALONE_LINUX
		...
		/* 機種固有のボイスプールID */
#if UNITY_EDITOR || UNITY_STANDALONE_WIN || UNITY_STANDALONE_OSX || UNITY_IOS || UNITY_TVOS || UNITY_PS3 || UNITY_WINRT || UNITY_XBOXONE || UNITY_WEBGL || UNITY_SWITCH || UNITY_STADIA || UNITY_STANDALONE_LINUX
#elif UNITY_ANDROID
...
#error unsupported platform
	...
	{
		UsedVoicesInfo info;
		CRIWARED48D3315((int)voicePoolId, out info.numUsedVoices, out info.numPoolVoices);
		return info;
	}
	...
	private static extern void CRIWARED48D3315(int voice_pool_id, out int num_used_voices, out int num_pool_voices);
	...
	#endif
	#else
	private static void CRIWARED48D3315(int voice_pool_id, out int num_used_voices, out int num_pool_voices)
