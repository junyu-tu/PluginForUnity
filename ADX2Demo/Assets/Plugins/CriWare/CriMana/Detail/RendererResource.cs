...
namespace CriMana.Detail
{
	public abstract class RendererResource : System.IDisposable
	{
		...
		{
			return CRIWARE2B315CF8(playerId);
		}
		...
		protected static extern bool CRIWAREE00232AA(
			int player_id,
			int num_textures,
		...
		[DllImport(CriWare.pluginName, CallingConvention = CriWare.pluginCallingConvention)]
		protected static extern bool CRIWARE1DB87507(
			int player_id,
			int num_textures,
        ...
        [DllImport(CriWare.pluginName, CallingConvention = CriWare.pluginCallingConvention)]
        protected static extern bool CRIWARE438463F2(
            int player_id,
            int num_textures,
            [In, Out] System.IntPtr[] tex_ptrs
        );
        ...
        [DllImport(CriWare.pluginName, CallingConvention = CriWare.pluginCallingConvention)]
        protected static extern bool CRIWAREDA57B27A(
            int player_id,
            int num_textures,
            [In, Out] System.IntPtr[] tex_ptrs
        );
        ...
        [DllImport(CriWare.pluginName, CallingConvention = CriWare.pluginCallingConvention)]
        protected static extern sbyte CRIWARE2B315CF8(
            int player_id
        );
		#else
		protected static bool CRIWAREE00232AA(
			int player_id,
			int num_textures,
			System.IntPtr[] tex_ptrs,
			[In, Out] FrameInfo frame_info,
		...
		protected static bool CRIWARE1DB87507(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

		protected static bool CRIWARE438463F2(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

		protected static bool CRIWAREDA57B27A(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

        protected static sbyte CRIWARE2B315CF8(
            int player_id
        ) { return 0; }
		#endif
		#endregion
